...
var ManifestActionComponent = (function (_React$Component) {
  ...
  ManifestActionComponent.prototype.render = function render() {
    ...
    var rawActionType = rawAction.type;
    var action = _extends({}, rawAction);
    if (rawActionType != null) {
      action.type = rawActionType.toString();
    }

    var actionWithNoType = _extends({}, rawAction);
    ...
    var actionBlock = this.state.expanded ? _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        JSON.stringify(actionWithNoType)
      )
    ) : null;
